...
$(document).ready(function(){
  ...
  setTimeout(function() {noty({text: '<strong>Hi! Welcome to IETF CodeStand!</strong>',layout:'topRight',type:'information',timeout:15000});}, 7000);

  setTimeout(function() {noty({text: 'Here comes the short description of IETF CodeStand, informing its goals, results so fac, etc.',layout:'topRight',type:'alert',timeout:13000});}, 9000);
